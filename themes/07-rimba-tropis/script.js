// =============================================================================
// VINVITE — THEME 07: RIMBA TROPIS — render logic
// =============================================================================
...
window.renderInvitation = function (data) {
  ...
  // Monogram wreath initials: first letter of each name.
  const monogram = document.getElementById("monogram-initials");
  if (monogram) monogram.innerHTML = `${groomShort.charAt(0)}&nbsp;&amp;&nbsp;${brideShort.charAt(0)}`;

  // Cover background photo (optional) — forest-green overlay keeps the
  // monogram wreath and brass text legible on top.
  if (data.cover_image_url) {
    const cover = document.getElementById("cover-screen");
    if (cover) {
      cover.style.backgroundImage = `linear-gradient(rgba(47,71,48,.87), rgba(47,71,48,.93)), url('${data.cover_image_url}')`;
  ...
  // Frond dividers draw themselves in as their section scrolls into view.
